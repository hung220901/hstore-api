...
exports.createPaymentVNPAY = async(req,res,next)=>{
    const now = moment()
    const expireTime = now.add(30, 'minutes');
    ...
    let secretKey = process.env.VNPAY_SCRETKEY;
...
// GET PAYMENT RESULT (IPN URL)
exports.getResultPaymentVNPay = async(req, res, next)=>{
    let vnp_Params = req.query;
    let secureHash = vnp_Params['vnp_SecureHash'];
    
    let orderId = vnp_Params['vnp_TxnRef'];
    let amount = vnp_Params['vnp_Amount'];
    let paymentMethod = vnp_Params['vnp_CardType']; 
...
// RETURN URL
exports.returnUrlVNPay = async(req,res,next)=>{
    let vnp_Params = req.query;
...
// QUERY TRANSACTION
exports.queryTransVNPay = async(req,res,next)=>{
    process.env.TZ = 'Asia/Ho_Chi_Minh';
    let date = new Date(); 
    let crypto = require("crypto");
    ...
    let secretKey = process.env.VNPAY_SCRETKEY;
    let vnp_Api = process.env.VNPAY_URL;
...
// REFUND
exports.refundVNPay = async(req,res,next)=>{
    process.env.TZ = 'Asia/Ho_Chi_Minh';
    let date = new Date();
